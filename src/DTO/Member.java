...
public class Member {
    ...
    public Member(int id, String firstName, String lastName, String phoneNumber, String email, String gender, byte[] picture) {
        this.id = id;
    ...
    public ArrayList<Member> memberList() {
        ...
        try {
            ...
            while(rs.next()) {
                member = new Member(rs.getInt("id"), rs.getString("firstName"), rs.getString("lastName"), rs.getString("phoneNumber"), rs.getString("email"), rs.getString("gender"), rs.getBytes("picture"));
                mList.add(member);
            }
        } catch (SQLException ex) {
            Logger.getLogger(Member.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public ArrayList<Member> memberListBy(String value) {
        ArrayList<Member> mList = new ArrayList<>();
