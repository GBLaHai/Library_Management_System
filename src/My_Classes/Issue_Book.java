...
public class Issue_Book {
    ...
    public ArrayList<Issue_Book> issuedBookList(String statusBook) {
        
        ArrayList<Issue_Book> issuedBookList = new ArrayList<>();
        String query = "";
        ...
        try {
            ...
            while(rs.next()) {
                ...
                issue_Book = new Issue_Book(book_id, member_id, status, issue_date, return_date, note);
