...
public class Book {
    ...
    public Book(int id, String isbn, String name, int author_id, int genre_id, int quantity, String publisher, double price, String date_received, String description, byte[] cover) {
        this.id = id;
        this.isbn = isbn;
        this.name = name;
    ...
    public Book searchBookByISBN(String _isbn) {
        ...
        try {
            if(rs.next()) {
                ...
                book = new Book(id, isbn, name, author_id, genre_id, quantity, publisher, price, date_received, description, cover);
            } else {
                return book;
            }
        } catch (SQLException ex) {
    ...
    public Book getBookByID(int _id) throws SQLException {
        ...
        if(rs.next()) {
                ...
                Book book = new Book(id, isbn, name, author_id, genre_id, quantity, publisher, price, date_received, description, cover);
    ...
    public ArrayList<Book> bookListByName(String value) {
        ArrayList<Book> bList = new ArrayList<>();
    ...
    public ArrayList<Book> bookListByDate(String dateFrom, String dateTo) {
        ArrayList<Book> bList = new ArrayList<>();
